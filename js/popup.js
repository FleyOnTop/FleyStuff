...
function popup12() {
  CreativaPopup.create(
    "This popup has a different background color.",
    "Title",
    "",
    {
      bgColor: "#ff0000",
...
function popup13() {
  CreativaPopup.create(
    'Feel free to DM me <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">fley.exe</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> or join my discord server <a href="https://discord.gg/fley" style="color: #ADD8E6;">https://discord.gg/fley</a> </font>',
    "Discord",
    "",
    {
      titleColor: "#6ffcff",
...
function allahm109kd() {
  navigator.clipboard.writeText("fley.exe");
  setTimeout(function () {
...
function popup19() {
  CreativaPopup.create(
    "This popup has a custom speed animation.",
    "Title",
    "",
    {
